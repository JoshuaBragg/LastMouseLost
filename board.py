...
class Board():
	...
	def win_board(self):
		win_b = [{0:4,3:2}, {0:4,2:2}, {0:3,1:1,2:1,3:1}, {0:3,1:3}, {0:1,1:5}, {0:4,4:2}, {0:2,1:2,3:2}, {0:2,1:2,2:2}, {0:2,3:4}, {0:2,2:2,3:2}, {0:1,1:3,2:1,3:1}, {0:1,1:3,2:1,3:1}, {0:2,2:4}, {0:1,1:1,2:3,3:1}]  #, {0:2,6:1,5:2,3:1}, {0:2,3:2,4:1,5:1}
